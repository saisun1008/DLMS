...
/**
 * Utility class to print out messages in the console Created by Sai on
 * 2015/5/25.
 */
public class ServerDisplayMsgs
{
    ...
    private final static String MANAGER_OPERATIONS = "4.Delay loan due date\n5.Print customer info\n6.Exit";
    ...
    public static int printCustomerOps()
    {
        ...
        System.out
                .println("Following two operations are for managers, login will be needed");
    ...
    public static String transferLoan()
    {
        if (m_inputStream == null)
        {
            m_inputStream = System.in;
        ...
        info += scan.nextLine();
        info += ";;d";
        System.out.println("Please enter current bank: ");
        info += scan.nextLine();
        info += ";;d";
        System.out.println("Please enter bank to be transfered to: ");
        info += scan.nextLine();
