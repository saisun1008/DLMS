 ...
 */
public abstract class DlmsInterfacePOA extends org.omg.PortableServer.Servant
        implements DlmsInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
    public DlmsInterface _this()
    {
        return DlmsInterfaceHelper.narrow(_this_object());
    }

    public DlmsInterface _this(org.omg.CORBA.ORB orb)
    {
        return DlmsInterfaceHelper.narrow(_this_object(orb));
    }
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_delayPayment(
        ...
        boolean _arg_result = delayPayment(arg0_in, arg1_in, arg2_in, arg3_in);
